...
var assertURLExists = function(targeturl) {
    var instr = targeturl.toString();
};
...
var checkHtmlFile = function(htmlfile, checksfile) {
    var htmlstring=cheerio.load(fs.readFileSync(htmlfile));
...
var checkURL = function(htmlurl, checksfile) {
    restler.get(htmlurl).on('complete', function(result, response) {
      if (result instanceof Error) {
        ...
        var htmlstring = cheerio.load(result);
